...
silverblaze relies on the [Rcpp](https://cran.r-project.org/web/packages/Rcpp/index.html) package, which requires the following OS-specific steps:
...
If you have any problems installing then please [raise an issue](https://github.com/Michael-Stevens-27/silverblaze/issues) on github.
