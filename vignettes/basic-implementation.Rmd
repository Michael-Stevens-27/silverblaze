...
```{r}
plot2 <- overlay_points(plot1, data_all$longitude, data_all$latitude)
...
```{r}
plot2 <- overlay_geoprofile(plot2, p, threshold = 0.1, opacity = 0.8, K = 5)
plot2
```
...
```{r}
piePlot <- overlay_piecharts(plot2, project = p, K = 2, min_size = 10, max_size = 30)
piePlot
```
