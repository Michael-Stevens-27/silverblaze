---
title: "Tutorial 6: Complex Spatial Priors"
...
sentGrid <- expand.grid(seq(Extent[1] + 0.1, Extent[2] - 0.1, l = 10), seq(Extent[3]+ 0.05, Extent[4]- 0.05, l = 10))
...
# uniform
plot3 <- plot_map()
plot3 <- overlay_geoprofile(plot3, pPopDen, K = 4, smoothing = 2, threshold = 1)
plot3 <- overlay_sources(plot3, lon = true_sources$longitude, lat = true_sources$latitude)
plot_loglike_diagnostic(pPopDen, K = 4)
plot3
```
